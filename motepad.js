...
define(
    ['jquery-1.9.1.min', 'htmlparser', 'motepad/AttributeSequence', 'motepad/layoutBlock', 'motepad/layoutMetaText'],
    function(jq, HTMLParser, createAttributeSequence, layoutBlock, layoutMetaText) {
